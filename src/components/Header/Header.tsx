    ...
    <header className="flex flex-col gap-2 justify-center items-center my-5">
      ...
      <div className="inline-flex gap-2">
        <h3 className="w-fit p-0.5 text-[rgb(181,138,170)] font-[Audiowide] text-[0.8rem] text-start">
          Create the perfect{" "}
          <span className="font-bold text-[rgb(10,69,38)]">ten</span> song,{" "}
          <br /> <span className="font-bold text-[rgb(10,69,38)]">forty</span>{" "}
          minute playlist
        </h3>
        <div className="flex flex-col justify-center">
          <h2 className="">Weekly Theme:</h2>
          <h2 className=" bg-[rgba(255,255,255,0.42)] font-bold text-green-600 border-b shadow-2xl border-b-gray-500 px-2 rounded-2xl">
            {weeklyTheme} Songs
          </h2>
        </div>
      </div>
